...
<body style="color: black;background-image: url(star.jpg);background-size: 100%;background-repeat: no-repeat;back">
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    <li class="nav-item px-1">
      <a class="nav-link"  href="home.php" >Crime Portal</a>
    </li>
    <li class="nav-item active">
      <a class="navbar-brand" href="inchargelogin.php">Incharge Login</a>
    </li>
  </ul>
</div>
</nav>
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    ...
    <input type="text"  name="email" class="form-control" required id="exampleInputEmail1" aria-describedby="emailHelp" size="5" placeholder="Enter Incharge Id" required onfocusout="f1()">
     </div>
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color:white">Password</h1></label>
    <input type="password" name="password" class="form-control" required id="exampleInputPassword1" placeholder="Password" required onfocusout="f1()">
  </div> 
