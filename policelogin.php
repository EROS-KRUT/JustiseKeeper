...
<body style="color: black;background-image: url(p_image.jpg);background-size: 100%;background-repeat: no-repeat;">
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item active">
      <a class="navbar-brand" href="policelogin.php">Police Login</a>
    </li>
  </ul>
</div>
</nav>
