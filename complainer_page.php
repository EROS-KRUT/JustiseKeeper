	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<form action="#" method="post"><div style="color: white">Aadhaar Number
					<input type="text"  name="aadhar_number" required="" disabled value=<?php echo "$a_no"; ?>>					
				<div class="top-w3-agile" style="color: white">Location of Crime                   
				...
				<div class="top-w3-agile" style="color: white">Type of Crime
					...
					Date Of Crime : &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp 
